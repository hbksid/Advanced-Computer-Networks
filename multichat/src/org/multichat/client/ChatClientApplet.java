...
import org.multichat.client.Recorder;
...
public class ChatClientApplet extends java.applet.Applet{
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        jPanel3 = new Panel(){ public Dimension getPreferredSize(){ return new Dimension( 640, 400 );} };
        jPanel2 = new Panel(){ public Dimension getPreferredSize(){ return new Dimension( 200, 20 );} };
        btnExit = new Button("Exit"){ public Dimension getPreferredSize(){ return new Dimension( 70, 20 );} };
        txtPort = new TextField(){ public Dimension getPreferredSize(){ return new Dimension( 200, 20 );} };
        txtPortAdr = new TextField(){ public Dimension getPreferredSize(){ return new Dimension( 50, 20 );} };
        btnConnect = new Button("Connect"){ public Dimension getPreferredSize(){ return new Dimension( 50, 20 );} };
        jScrollPane1 = new ScrollPane();
        txtOutput = new TextArea();
        nickPanHolder = new Panel(){ public Dimension getPreferredSize(){ return new Dimension( 100, 100 );} };
        jScrollPane2 = new ScrollPane();
        lstNick = new java.awt.List();
        jPanel1 = new Panel(){ public Dimension getPreferredSize(){ return new Dimension( 163, 180 );} };
        btnPan = new Panel(){ public Dimension getPreferredSize(){ return new Dimension( 63, 80 );} };
        btnTalk = new Button("Talk"){ public Dimension getPreferredSize(){ return new Dimension( 63, 80 );} };
	...
	*/
	    ...
	    synchronized public void run(){
	            try{
	            	...
	            	if( recievedByteVector.size() > 0 ){
		                ...
		                else if( sizeread < 100 && passedObj.length() >= 3 && passedObj.substring(0,3).equals("bye")){
		                    imRunning = false;
		                }
		                ...
		                else if( sizeread < 100 && passedObj.length() >= 2 && passedObj.substring(0,2).equals("ST")){ // more then two peole in chat someone talking
		                ...
		                else if( sizeread < 100 && passedObj.length() >= 2 && passedObj.substring(0,2).equals("PT")){ // one on one chat someone is talking
		                    for( int i = 0; i < NickNameVector.size(); i++){
		                        if( (NickNameVector.elementAt(i) + "" ).equals( passedObj.substring(2)) ){
		                            lstNick.select(i);
		                            break;
    ...
    public class myOwnThread extends Thread{
	    ...
	    public void run() {
			...
			*If yoru going to write a program that will use this as the main chat Buddy list instead of a chat window
